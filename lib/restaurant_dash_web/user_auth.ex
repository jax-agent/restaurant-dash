defmodule RestaurantDashWeb.UserAuth do
  ...
  alias RestaurantDash.Accounts.Scope

  # ─── LiveView on_mount hooks ─────────────────────────────────────────────

  @doc """
  on_mount hook: fetches the current user from session and assigns it to socket.
  Use in LiveViews for authentication.
  ...
  @remember_me_cookie "_restaurant_dash_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      RestaurantDashWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
