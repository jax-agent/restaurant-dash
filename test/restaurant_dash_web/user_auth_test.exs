defmodule RestaurantDashWeb.UserAuthTest do
  use RestaurantDashWeb.ConnCase, async: true

  alias RestaurantDash.Accounts
  alias RestaurantDash.Accounts.Scope
  alias RestaurantDashWeb.UserAuth

  import RestaurantDash.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, RestaurantDashWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
