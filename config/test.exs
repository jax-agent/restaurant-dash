...
config :restaurant_dash, RestaurantDash.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "restaurant_dash_test#{System.get_env("MIX_TEST_PARTITION")}",
...
# Disable Oban in tests (use manual testing mode — jobs queued but not auto-run)
config :restaurant_dash, Oban, testing: :manual
