...
#
#     PHX_SERVER=true bin/restaurant_dash start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :restaurant_dash, RestaurantDashWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :restaurant_dash, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :restaurant_dash, RestaurantDash.Mailer,
